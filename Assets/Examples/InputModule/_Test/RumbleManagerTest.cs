...
public class RumbleManagerTest
{
    ...
    private IRumbleInfo CreateRumbleInfo() =>
        new RumbleInfo(DataId, Duration, CreateControlSchemeInfos());

    private ControlSchemeInfo[] CreateControlSchemeInfos() =>
        new[] { new ControlSchemeInfo(ControlSchemeDataId, LowFrequency, HighFrequency) };
}