...
namespace DataType
{
	...
	{
		[Preserve]
		public HashSetDataType(Type type, BaseDataType elementDataType, IDataTypeController dataTypeController, IReflectionHelper reflectionHelper) : base(type, elementDataType, dataTypeController, reflectionHelper) { }
		...
		public override void ReadInto(IReader reader, object obj) =>
			throw new NotImplementedException("[HashSetDataType::ReadInto] Cannot use LoadInto/ReadInto with HashSet because HashSets do not maintain the order of elements");
	}
}
