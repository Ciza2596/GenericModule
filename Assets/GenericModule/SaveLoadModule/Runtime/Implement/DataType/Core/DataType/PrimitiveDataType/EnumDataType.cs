...
namespace DataType
{
    ...
    public class EnumDataType : DataType
    {
        ...
        {
            if (_underlyingType == typeof(bool)) 
                writer.WritePrimitive((bool)obj);
            
            else if (_underlyingType == typeof(char)) 
            ...
            else if (_underlyingType == typeof(decimal)) 
                ...
                throw new System.InvalidCastException($"[EnumDataType::Write] The underlying type: {_underlyingType} of Enum {Type} is not supported.");
        }
        ...
        public override object Read<T>(IReader reader)
        {
            ...
            if (_underlyingType == typeof(char)) 
