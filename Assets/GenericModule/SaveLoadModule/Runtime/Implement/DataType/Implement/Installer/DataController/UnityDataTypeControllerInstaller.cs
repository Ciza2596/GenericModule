...
namespace DataType.Implement
{
	public class UnityDataTypeControllerInstaller : IDataTypeControllerInstaller
	{
		...
		public void Install(Dictionary<Type, BaseDataType> dataTypes, IDataTypeController dataTypeController, IReflectionHelper reflectionHelper)
		{
			...
			AddDataTypeToDataTypes(vector2DataType, new Vector2ArrayDataType(vector2DataType, dataTypeController, reflectionHelper));

			var vector2IntDataType = new Vector2IntDataType(intDataType, dataTypeController, reflectionHelper);
			AddDataTypeToDataTypes(vector2IntDataType, new Vector2IntArrayDataType(vector2IntDataType, dataTypeController, reflectionHelper));

			var vector3DataType = new Vector3DataType(floatDataType, dataTypeController, reflectionHelper);
			AddDataTypeToDataTypes(vector3DataType, new Vector3ArrayDataType(vector3DataType, dataTypeController, reflectionHelper));

			var vector3IntDataType = new Vector3IntDataType(intDataType, dataTypeController, reflectionHelper);
			AddDataTypeToDataTypes(vector3IntDataType, new Vector3IntArrayDataType(vector3IntDataType, dataTypeController, reflectionHelper));
