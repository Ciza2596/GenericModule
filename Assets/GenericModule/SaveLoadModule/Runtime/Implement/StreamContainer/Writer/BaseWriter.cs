...
namespace SaveLoadModule.Implement
{
    public abstract class BaseWriter : IWriter, DataType.IWriter
    {
        ...
        public void WriteProperty(string name, object value, DataType.DataType dataType, DataType.ReferenceModes referenceMode)
        {
        ...
        public void Write(object value, DataType.DataType dataType, DataType.ReferenceModes referenceMode)
        {
            ...
            if (dataType.IsDictionary)
            {
                ...
                ((DictionaryDataType)dataType).Write(value, this, referenceMode);
                EndWriteDictionary();
                return;
            }
