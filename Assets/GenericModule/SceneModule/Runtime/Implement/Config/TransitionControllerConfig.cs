...
namespace SceneModule.Implement
{
    ...
    public class TransitionControllerConfig : ScriptableObject, ITransitionControllerConfig
    {
        ...
        {
            var viewPrefab = _isViewName
                ? GetViewPrefabByViewName(_transitionInViewPrefabMaps, viewNameOrTag)
                : GetViewPrefabByViewTag(_transitionInViewPrefabMaps, viewNameOrTag);
            return viewPrefab;
        }
        ...
        {
            var viewPrefab = _isViewName
                ? GetViewPrefabByViewName(_loadingViewPrefabMaps, viewNameOrTag)
                : GetViewPrefabByViewTag(_loadingViewPrefabMaps, viewNameOrTag);
            return viewPrefab;
        }
        ...
        {
            var viewPrefab = _isViewName
                ? GetViewPrefabByViewName(_transitionOutViewPrefabMaps, viewNameOrTag)
                : GetViewPrefabByViewTag(_transitionOutViewPrefabMaps, viewNameOrTag);
            return viewPrefab;
        }
        ...
        private GameObject GetViewPrefabByViewName(ViewPrefabMap[] viewMaps, string viewName)
        {
            ...
            Assert.IsNotNull(viewMap,
                $"[TransitionControllerConfig::GetViewPrefabByViewName] Not find prefab with viewName: {viewName}");
        ...
        private GameObject GetViewPrefabByViewTag(ViewPrefabMap[] viewMaps, string viewTag)
        {
            ...
            Assert.IsNotNull(viewMap,
                $"[TransitionControllerConfig::GetViewPrefabByViewTag] Not find prefab with viewTag: {viewTag}");
