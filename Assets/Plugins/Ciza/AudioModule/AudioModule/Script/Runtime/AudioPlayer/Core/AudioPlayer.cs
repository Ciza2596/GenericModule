...
namespace CizaAudioModule
{
	public class AudioPlayer : MenuAudioController.IAudioPlayer
	{
		...
		public string SpawnBgm(string bgmDataId, string userId, float volume = 1, bool isLoop = false, Vector3 position = default, string callerId = null) =>
			_bgmModule.Spawn(bgmDataId, userId, volume, isLoop, position, callerId);

		public string SpawnBgm(string bgmDataId, float volume = 1, bool isLoop = false, Vector3 position = default, string callerId = null) =>
			_bgmModule.Spawn(bgmDataId, string.Empty, volume, isLoop, position, callerId);

		public string SpawnBgm(bool isCustomBgmId, string bgmId, string bgmDataId, string userId, float volume = 1, bool isLoop = false, Vector3 position = default, string callerId = null) =>
			_bgmModule.Spawn(isCustomBgmId, bgmId, bgmDataId, userId, volume, isLoop, position, callerId);


		public UniTask<string> PlayBgmAsync(string bgmDataId, string userId, float volume = 1, float fadeTime = 0, bool isLoop = false, Vector3 position = default, string callerId = null) =>
			_bgmModule.PlayAsync(bgmDataId, userId, volume, fadeTime, isLoop, position, callerId);
		...
		public string SpawnSfx(string sfxDataId, string userId, float volume = 1, bool isLoop = false, Vector3 position = default, string callerId = null) =>
			_sfxModule.Spawn(sfxDataId, userId, volume, isLoop, position, callerId);

		public string SpawnSfx(string sfxDataId, float volume = 1, bool isLoop = false, Vector3 position = default, string callerId = null) =>
			_sfxModule.Spawn(sfxDataId, string.Empty, volume, isLoop, position, callerId);

		public string SpawnSfx(bool isCustomSfxId, string sfxId, string sfxDataId, string userId, float volume = 1, bool isLoop = false, Vector3 position = default, string callerId = null) =>
			_sfxModule.Spawn(isCustomSfxId, sfxId, sfxDataId, userId, volume, isLoop, position, callerId);

		public void DeSpawnSfx(string sfxId) =>
			_sfxModule.DeSpawn(sfxId);


		public UniTask<string> PlaySfxAsync(string sfxDataId, string userId, float volume = 1, float fadeTime = 0, bool isLoop = false, Vector3 position = default, string callerId = null) =>
			_sfxModule.PlayAsync(sfxDataId, userId, volume, fadeTime, isLoop, position, callerId);
		...
		public string SpawnVoice(string voiceDataId, string userId, float volume = 1, bool isLoop = false, Vector3 position = default, string callerId = null) =>
			_voiceModule.Spawn(voiceDataId, userId, volume, isLoop, position, callerId);

		public string SpawnVoice(string voiceDataId, float volume = 1, bool isLoop = false, Vector3 position = default, string callerId = null) =>
			_voiceModule.Spawn(voiceDataId, string.Empty, volume, isLoop, position, callerId);

		public string SpawnVoice(bool isCustomVoiceId, string voiceId, string voiceDataId, string userId, float volume = 1, bool isLoop = false, Vector3 position = default, string callerId = null) =>
			_voiceModule.Spawn(isCustomVoiceId, voiceId, voiceDataId, userId, volume, isLoop, position, callerId);
		...
		public UniTask<string> PlayVoiceAsync(string voiceDataId, string userId, float volume = 1, float fadeTime = 0, bool isLoop = false, Vector3 position = default, string callerId = null) =>
			_voiceModule.PlayAsync(voiceDataId, userId, volume, fadeTime, isLoop, position, callerId);
