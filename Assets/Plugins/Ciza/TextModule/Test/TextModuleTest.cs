...
public class TextModuleTest
{
    ...
    private static readonly string[] ExpectedTexts = new[] { "J_Icon", "A_Icon", "X_Icon" };
    ...
    public void _04_TryChangeCategory()
    {
        ...
        Assert.AreEqual(ExpectedTexts[0], text1);
        ...
        Assert.AreEqual(ExpectedTexts[2], text2);
    }
    ...
    public void _05_TryGetText()
    {
        ...
        Assert.AreEqual(ExpectedTexts[0], text);
    }
