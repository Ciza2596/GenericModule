...
public class EventModuleTest
{
	...
	public void _01_Should_HasOneSyncEventDelegateContainer_When_AddSyncListener()
	{
		...
		//assert
		Assert.AreEqual(1, _eventModule.SyncEventCount, "SyncEvents count not match AddSyncListener times. Please check AddSyncListener times.");
	}
	...
	public void _02_Should_HasntSyncEventDelegateContainer_When_RemoveSyncListener()
	{
		//arrange
		_eventModule.AddSyncListener<TestSyncEvent>(OnTestSyncAction);
		Assert.AreEqual(1, _eventModule.SyncEventCount, "Test init fail. SyncEvents count not match AddSyncListener times. Please check AddSyncListener times.");
		...
		//assert
		Assert.AreEqual(0, _eventModule.SyncEventCount, "SyncEvents count not match AddSyncListener times. Please check RemoveSyncListener times.");
	}
	...
	public void _03_Should_isTestSyncActionTriggerBeTrue_When_NotifySyncEvent()
	{
		...
		_eventModule.AddSyncListener<TestSyncEvent>(OnTestSyncAction);
		Assert.IsFalse(_isTestSyncActionTrigger, "Test init fail. Please check _isTestSyncActionTrigger should be false.");
		Assert.AreEqual(1, _eventModule.SyncEventCount, "Test init fail. SyncEvents count not match AddSyncListener times. Please check AddSyncListener times.");
	...
	public void _04_Should_HasOneAsyncEventDelegateContainer_When_AddAsyncListener()
	{
		...
		//assert
		Assert.AreEqual(1, _eventModule.AsyncEventCount, "AsyncEvents count not match AddAsyncListener times. Please check AddAsyncListener times.");
	}
	...
	public void _05_Should_HasntAsyncEventDelegateContainer_When_RemoveAsyncListener()
	{
		//arrange
		_eventModule.AddAsyncListener<TestAsyncEvent>(OnTestAsyncAction);
		Assert.AreEqual(1, _eventModule.AsyncEventCount, "Test init fail. AsyncEvents count not match AddAsyncListener times. Please check AddAsyncListener times.");
		...
		//assert
		Assert.AreEqual(0, _eventModule.AsyncEventCount, "AsyncEvents count not match AddAsyncListener times. Please check RemoveAsyncListener times.");
	}
	...
	public async void _05_Should_IsTestAsyncActionTriggerBeTrue_And_HasCancellationTokenBeFalse_CancelToke_When_NotifyAsyncEvent()
	{
		...
		_eventModule.AddAsyncListener<TestAsyncEvent>(OnTestAsyncAction);
		Assert.IsFalse(_isTestAsyncActionTrigger, "Test init fail. Please check _isTestAsyncActionTrigger should be false.");
		Assert.AreEqual(_eventModule.AsyncEventCount, 1, "Test init fail. AsyncEvents count not match AddAsyncListener times. Please check AddAsyncListener times.");
